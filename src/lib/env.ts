...
const schema = z
  .object({
    ...
    META_EMBEDDED_SIGNUP_ENABLED: z.enum(["true", "false"]).default("false").transform((value) => value === "true"),
    META_EMBEDDED_SIGNUP_CONFIG_ID: optionalCatalogId,
    META_BUSINESS_ID: optionalCatalogId,
    META_EMBEDDED_SIGNUP_GRAPH_VERSION: z.string().regex(/^v\d+\.\d+$/).default("v26.0"),
