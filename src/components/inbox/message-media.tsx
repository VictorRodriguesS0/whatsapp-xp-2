...
export function MessageMedia({
  ...
  if (message.type === "IMAGE") {
    ...
    return <button aria-label="Abrir imagem" className="block cursor-zoom-in rounded-md outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]" onClick={() => onOpenMedia(message.id)} ref={(element) => { reconciledFocusTarget.current = element; }} type="button">{image}</button>;
  }
  ...
  if (message.type === "VIDEO") {
    ...
    return (
      <button aria-label="Abrir vídeo" className="group/video relative block overflow-hidden rounded-md outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]" onClick={() => onOpenMedia(message.id)} ref={(element) => { reconciledFocusTarget.current = element; }} type="button">
